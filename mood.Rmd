...
Now, we are *not* saying that putting words to your emotions will make negative feelings go away. It will only help reduce how strong the feelings are, and only on average (so sometimes it may work sometimes it may not. The real reason we think it is important to put emotions into words is because different emotions are associated to different thoughts. In the next section, you will learn how to use your feelings to help change what you are thinking about.